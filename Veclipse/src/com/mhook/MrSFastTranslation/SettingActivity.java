...
public class SettingActivity extends Activity implements TransView,OnClickListener,OnSeekBarChangeListener,OnCheckedChangeListener
{
	...
	public void showHelpInfo()
	{
		...
		AlertUtils.TwoBtnAlert(this, "使用说明", "1.请不要用类似阻止运行的软件阻止本软件\n\n2.请不要禁止本软件的联网权限和悬浮窗权限.", "知道了", new DialogInterface.OnClickListener(){
			...
			}, "下次不再提示", new DialogInterface.OnClickListener(){
				...
				public void onClick(DialogInterface p1, int p2)
				{
					...
					transPresenter.onClickForShowHelpInfo(false);
